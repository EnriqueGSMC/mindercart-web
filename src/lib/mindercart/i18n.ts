...
const categoryMap: Record<string, { es: string; en: string }> = {
  "frutas y verduras": { es: "Frutas y Verduras", en: "Fruits and Vegetables" },
  "fruits & vegetables": { es: "Frutas y Verduras", en: "Fruits and Vegetables" },
  produce: { es: "Frutas y Verduras", en: "Fruits and Vegetables" },

  "carnes, pollo y pescados": { es: "Carnes, Pollo y Pescados", en: "Meat, Poultry and Seafood" },
  "meat, poultry & seafood": { es: "Carnes, Pollo y Pescados", en: "Meat, Poultry and Seafood" },
  "meat & seafood": { es: "Carnes, Pollo y Pescados", en: "Meat, Poultry and Seafood" },
  carnes: { es: "Carnes, Pollo y Pescados", en: "Meat, Poultry and Seafood" },

  "jamon y salchichoneria": { es: "Jamón y Salchichonería", en: "Deli Meats and Cold Cuts" },
  "jamón y salchichonería": { es: "Jamón y Salchichonería", en: "Deli Meats and Cold Cuts" },
  "deli meats & cold cuts": { es: "Jamón y Salchichonería", en: "Deli Meats and Cold Cuts" },
  "deli meats and cold cuts": { es: "Jamón y Salchichonería", en: "Deli Meats and Cold Cuts" },
  "cold cuts": { es: "Jamón y Salchichonería", en: "Deli Meats and Cold Cuts" },
  deli: { es: "Jamón y Salchichonería", en: "Deli Meats and Cold Cuts" },

  "lacteos y refrigerados": { es: "Lácteos y Refrigerados", en: "Dairy and Chilled" },
  "dairy & refrigerated": { es: "Lácteos y Refrigerados", en: "Dairy and Chilled" },
  dairy: { es: "Lácteos y Refrigerados", en: "Dairy and Chilled" },
  refrigerated: { es: "Lácteos y Refrigerados", en: "Dairy and Chilled" },

  "panaderia y tortilleria": { es: "Panadería y Tortillería", en: "Bakery and Tortilleria" },
  "bakery & tortillas": { es: "Panadería y Tortillería", en: "Bakery and Tortilleria" },
  bakery: { es: "Panadería y Tortillería", en: "Bakery and Tortilleria" },

  abarrotes: { es: "Abarrotes", en: "Pantry and Groceries" },
  "grocery staples": { es: "Abarrotes", en: "Pantry and Groceries" },
  pantry: { es: "Abarrotes", en: "Pantry and Groceries" },
  despensa: { es: "Abarrotes", en: "Pantry and Groceries" },

  bebidas: { es: "Bebidas", en: "Beverages" },
  beverages: { es: "Bebidas", en: "Beverages" },

  "vinos y licores": { es: "Vinos y Licores", en: "Wine and Spirits" },
  "wine & spirits": { es: "Vinos y Licores", en: "Wine and Spirits" },
  "wine and spirits": { es: "Vinos y Licores", en: "Wine and Spirits" },
  wine: { es: "Vinos y Licores", en: "Wine and Spirits" },
  spirits: { es: "Vinos y Licores", en: "Wine and Spirits" },
  liquor: { es: "Vinos y Licores", en: "Wine and Spirits" },

  congelados: { es: "Congelados", en: "Frozen" },
  frozen: { es: "Congelados", en: "Frozen" },

  "limpieza y hogar": { es: "Limpieza y Hogar", en: "Cleaning and Home" },
  "cleaning & home": { es: "Limpieza y Hogar", en: "Cleaning and Home" },
  cleaning: { es: "Limpieza y Hogar", en: "Cleaning and Home" },
  household: { es: "Limpieza y Hogar", en: "Cleaning and Home" },
  hogar: { es: "Limpieza y Hogar", en: "Cleaning and Home" },

  "farmacia, bebe y cuidado personal": { es: "Farmacia, Bebé y Cuidado Personal", en: "Pharmacy, Baby and Personal Care" },
  "pharmacy, baby & personal care": { es: "Farmacia, Bebé y Cuidado Personal", en: "Pharmacy, Baby and Personal Care" },
  pharmacy: { es: "Farmacia, Bebé y Cuidado Personal", en: "Pharmacy, Baby and Personal Care" },
  "personal care": { es: "Farmacia, Bebé y Cuidado Personal", en: "Pharmacy, Baby and Personal Care" },
  bebe: { es: "Farmacia, Bebé y Cuidado Personal", en: "Pharmacy, Baby and Personal Care" },
  baby: { es: "Farmacia, Bebé y Cuidado Personal", en: "Pharmacy, Baby and Personal Care" },

  mascotas: { es: "Mascotas", en: "Pet Care" },
  pets: { es: "Mascotas", en: "Pet Care" },
  "pet care": { es: "Mascotas", en: "Pet Care" },

  "ferreteria y autos": { es: "Ferretería y Autos", en: "Hardware and Auto" },
  "ferretería y autos": { es: "Ferretería y Autos", en: "Hardware and Auto" },
  "hardware & auto": { es: "Ferretería y Autos", en: "Hardware and Auto" },
  "hardware and auto": { es: "Ferretería y Autos", en: "Hardware and Auto" },
  hardware: { es: "Ferretería y Autos", en: "Hardware and Auto" },
  auto: { es: "Ferretería y Autos", en: "Hardware and Auto" },
  autos: { es: "Ferretería y Autos", en: "Hardware and Auto" },

  "cajas y salida": { es: "Cajas y Salida", en: "Checkout and Front Area" },
  "checkout & front end": { es: "Cajas y Salida", en: "Checkout and Front Area" },
  checkout: { es: "Cajas y Salida", en: "Checkout and Front Area" },
  "front end": { es: "Cajas y Salida", en: "Checkout and Front Area" },
